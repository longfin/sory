(defproject attendance-check "0.1.0-SNAPSHOT"
  ...
  {:uberjar {:omit-source true
   ...
   :project/dev  {:dependencies [[ring/ring-mock "0.3.0"]
                  ...
                  {:http-server-root "public"
                   ...
                   :ring-handler attendance-check.handler/app}
                  
                  :repl-options {:init-ns attendance-check.core}
